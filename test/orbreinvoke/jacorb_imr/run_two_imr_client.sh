...
if [[ -z $serverName ]] ; then
    echo "$bn: Usage: $bn <EchoServer1 or EchoServer2> <remote ImR hostname>"
    exit 1
fi
...
[[ -z $remote_imr_host ]] && remote_imr_host="phil.ociweb.com"
...
corbaloc="corbaloc::${imr_host}:44444,:${remote_imr_host}:44444/${serverName}/EchoServer-POA/${serverName}-ID"
